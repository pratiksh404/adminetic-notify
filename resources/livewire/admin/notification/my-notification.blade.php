                            ...
                            <div class="email-app-sidebar">
                                ...
                                <ul class="nav main-menu" role="tablist">
                                    ...
                                    <li><a href="#" wire:click="setAction(2)"><span class="title"><i
                                                ...
                                                class="badge pull-right">({{$unreadNotifications->count()
                                                ?? 0}})</span></a>
                                    </li>
                                    <li><a href="#" wire:click="setAction(3)"><span class="title"><i
                                                    class="icon-folder"></i> All
                                                Notifications</span><span
                                                class="badge pull-right">({{$notifications->count()
                                                ?? 0}})</span></a>
                                    </li>
                                    <li>
                                        <a href="#" wire:click="setAction(4)"><span class="title"><i
                                                ...
                                                Severity
                                                Notifications</span><span
                                                class="badge pull-right">({{$insignificantSeverityNotifications->count()
                                                ?? 0}})</span></a>
                                    </li>
                                    <li>
                                        <a href="#" wire:click="setAction(5)"><span class="title"><i
                                                ...
                                                Notifications</span><span
                                                class="badge pull-right">({{$lowSeverityNotifications->count()
                                                ?? 0}})</span></a>
                                    </li>
                                    <li>
                                        <a href="#" wire:click="setAction(6)"><span class="title"><i
                                                ...
                                                Notifications</span><span
                                                class="badge pull-right">({{$midSeverityNotifications->count()
                                                ?? 0}})</span></a>
                                    </li>
                                    <li>
                                        <a href="#" wire:click="setAction(7)"><span class="title"><i
                                                ...
                                                Notifications</span><span
                                                class="badge pull-right">({{$highSeverityNotifications->count()
                                                ?? 0}})</span></a>
                                    </li>
                                    <li>
                                        <a href="#" wire:click="setAction(8)"><span class="title"><i
                                                ...
                                                Severity
                                                Notifications</span><span
                                                class="badge pull-right">({{$veryHighSeverityNotifications->count()
                                                ?? 0}})</span></a>
                                    </li>
                                    <li>
                                        <hr>
                            ...
                            <div class="col-xl-4 col-md-12 box-md-12 pr-0" style="height: 70vh;overflow-y:auto">
                                        ...
                                        <div class="col text-end">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end"
                                                    ...
                                                    <a class="dropdown-item" wire:click="$set('limit',5)" href="#">5</a>
                                ...
                                <div class="card-body pb-0" style="padding: 10px;">
                                    ...
                                    <div wire:loading.remove wire:target="setAction,getCategoryNotfications">
                                        ...
                                        @if ($loop->iteration <= $limit) <div class="card mb-1 notification-tile">
                                            <div class="card-body shadow-sm p-2">
                                                <a href="#" wire:click="show_notification('{{$notification->id}}')"
                                                    class="media">
                                    ...
                                    @endif
                                    @endforeach
                                    <button wire:loading wire:target="loadMore" class="btn btn-outline-primary" disabled
                                        style="width: 100%">Loading
                                        ...</button>
                                    <button wire:loading.remove wire:target="loadMore" class="btn btn-outline-primary"
                                        wire:click="loadMore" style="width: 100%">Load
                                        More ...</button>
                                    @else
                                    ...
                                    <div class="ps-0">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4 btn-middle xl-50">
                                                            <button wire:loading.remove wire:target="send"
                                                                ...
                                                                type="submit"><i class="fa fa-paper-plane me-2"></i>
                                                                SEND</button>
                                                    ...
                                                    <div class="theme-form">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <textarea name="text-box" id="message"
                                                                    class="form-control"
                                        ...
                                        <div wire:loading.remove wire:target="show_notification">
                                            ...
                                            <div style="margin-right:12px"
                                                ...
                                                <span
                                                    style="margin-right: 100px">{{severity($active_notification->data['severity']
                                                    ?? 0) ?? 'Not
                                                    Specified'}}</span>
                                            </div>
